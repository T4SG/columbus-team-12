...
#include "radio_button_exercise_window.h"
...
static void draw_row_callback(GContext *ctx, Layer *cell_layer, MenuIndex *cell_index, void *context) {
  if(cell_index->row == RADIO_BUTTON_WINDOW_NUM_ROWS) {
    ...
    case 0:
      snprintf(s_buff, sizeof(s_buff), "No exercise");
      break;
    case 1:
      snprintf(s_buff, sizeof(s_buff), "20 - 40 minutes");
      break;
    case 2:
      snprintf(s_buff, sizeof(s_buff), "40-60 minutes");
      break;
    case 3:
      snprintf(s_buff, sizeof(s_buff), ">60 minutes");
      break;
    default:
      break;
  }
...
void radio_button_window_exercise_push() {
  if(!s_main_window) {
